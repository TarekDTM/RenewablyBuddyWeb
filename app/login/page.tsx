...
export default function Home() {
    ...
    return (
        <div className=" flex flex-row w-full h-full">
            <Container  className="bg-white flex flex-col justify-between" padding={8}>
            ...
            <Container bgImage={'url(https://picsum.photos/id/100/200/300)'} width={"50%"} bgRepeat={'no-repeat'} backgroundSize={'cover'}  >
            </Container>
        </div>
    );
}
